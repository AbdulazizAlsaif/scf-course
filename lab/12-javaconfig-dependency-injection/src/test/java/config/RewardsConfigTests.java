...
public class RewardsConfigTests {
	...
	public void getBeans() {
		RewardNetwork rewardNetwork = rewardsConfig.rewardNetwork(rewardsConfig.accountRepository(),rewardsConfig.restaurantRepository(),rewardsConfig.rewardRepository());
