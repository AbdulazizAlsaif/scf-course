...
//		}
		...
		restaurant=	jdbcTemplate.queryForObject(sql,
				(rs, rowNum) ->  {
					Restaurant restaurant1=new Restaurant(rs.getString("MERCHANT_NUMBER"),rs.getString("NAME"));
					restaurant1.setBenefitPercentage(Percentage.valueOf(rs.getString("BENEFIT_PERCENTAGE")));
